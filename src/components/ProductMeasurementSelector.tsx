...
const ProductMeasurementSelector: React.FC<ProductMeasurementSelectorProps> = ({ session }) => {
      ...
      <CardContent>
        <form onSubmit={handleSaveMeasurements} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <RadioGroup onValueChange={setSelectedMeasurementType} value={selectedMeasurementType} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Label
